...
function Contactpage() {
  return (
    <div className=" mt-[6rem] mb-[6rem] grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-800 text-gray-100">
    ...
    <form className="space-y-6">
      ...
      <button type="submit" className="w-full p-3 text-sm font-bold tracki uppercase rounded bg-purple-400 text-gray-900">Send Message</button>
    </form>
  </div>
  )
}
