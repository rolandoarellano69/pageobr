...
function DiagBubble({text}) {
  return (
    <motion.div
    className="hidden md:block relative top-7 right-[10rem] bg-gradient-to-r bg-gray-100  px-4 py-2 rounded-full shadow-md"
    initial={{ scale: 0 }}
    animate={{ rotate: 360, scale: 1 }}
    transition={{ type: "spring", stiffness: 260, damping: 20 }}
  >
    <p className="text-slate-950 text-sm font-medium">{text}</p>
