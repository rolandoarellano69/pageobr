    ...
    <footer className="bg-primary mt-[2rem]">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
          ...
          <li>
            <Link className="text-gray-200 transition hover:text-gray-700/75" href="/desarrollo">
              Desarrollo
            </Link>
          </li>
          
          <li>
            <Link className="text-gray-200 transition hover:text-gray-700/75" href="/nosotros">
             Nosotros
            </Link>
          </li>

          <li>
            <Link className="text-gray-200 transition hover:text-gray-700/75" href="/blog">
              Blog
            </Link>
          </li>

          <li>
            <Link className="text-gray-200 transition hover:text-gray-700/75" href="/contacto">
              Contacto
            </Link>
          </li>
        </ul>
