    ...
    <div className=" flex justify-center items-center bg-white w-full h-auto md:h-50 p-4 md:p-8">
      ...
      <section className="py-6 bg-white text-gray-50">
        <div className="container mx-auto flex flex-col items-center justify-center max-w-lg p-4 lg:max-w-full sm:p-10 lg:flex-row">
          <div className="flex flex-col items-center justify-center flex-1 p-4 pb-8 sm:p-8 lg:p-16 bg-secondary rounded-l-md">
          ...
          <div className="flex flex-col items-center justify-center flex-1 p-4 pb-8 text-center  sm:p-8 lg:p-16 bg-primary rounded-r-md text-gray-100">
            ...
            <p className="font-ligth text-left mt-4">Empresa socialmente responsable, líder en el sector inmobiliario con personal profesional y talentoso, para el desarrollo de vivienda con espíritu residencial, creando comunidades organizadas y sustentables, que maximice la calidad de vida de sus residentes.</p>
