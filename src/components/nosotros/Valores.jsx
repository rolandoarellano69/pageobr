...
function Valores() {
  return (
    ...
    >
      <SwiperSlide>
        <div className='flex flex-col justify-center items-center '>
          <Image src={'/RESPONSABILIDAD.png'} alt="House" width={100} height={100} className='rounded-full' />
          <p className='text-center mb-2'>Responsabilidad</p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='flex flex-col justify-center items-center'>
          <Image src={'/HONESTIDAD.png'} alt="House" width={100} height={100} className='rounded-full' />
          <p className='text-center mt-2'>Honestidad</p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='flex flex-col justify-center items-center'>
          <Image src={'/CONFIABILIDAD.png'} alt="House" width={100} height={100} className='rounded-full' />
          <p className='text-center mt-2'>Confiabilidad</p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='flex flex-col justify-center items-center'>
          <Image src={'/SERVICIO.png'} alt="House" width={100} height={100} className='rounded-full' />
          <p className='text-center mt-2'>Servicio</p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='flex flex-col justify-center items-center'>
          <Image src={'/COMPROMISO.png'} alt="House" width={100} height={100} className='rounded-full' />
          <p className='text-center mt-2'>Compromiso</p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='flex flex-col justify-center items-center'>
          <Image src={'/PASION.png'} alt="House" width={100} height={100} className='rounded-full' />
          <p className='text-center mt-2'>Pasión</p>
        </div>
      </SwiperSlide>
    ...
    <div className=" grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-10 gap-8 hidden md:flex lg:flex lg:justify-center">
      {/* Valor 1 */}
      <div className='flex flex-col justify-center items-center'>
        <Image src={'/RESPONSABILIDAD.png'} alt="House" width={200} height={200} className='rounded-full' />
        <p className='text-center mt-2'>Responsabilidad</p>
      </div>
      {/* Valor 2 */}
      <div className='flex flex-col justify-center items-center'>
